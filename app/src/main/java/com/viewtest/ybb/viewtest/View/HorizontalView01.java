...
public class HorizontalView01 extends ViewGroup{
    ...
    public HorizontalView01(Context context) {
        super(context);
        init();
    }
    public HorizontalView01(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    public HorizontalView01(Context context, AttributeSet attrs, int defStyleAttr) {
